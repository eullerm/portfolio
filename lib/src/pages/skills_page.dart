...
class SkillsPage extends StatefulWidget {
  ...
  const SkillsPage({super.key, this.arguments, required this.page, required this.numberOfPages});
...
class _SkillsPageState extends State<SkillsPage> {
  ...
  Future<void> fetchSkillsData() async {
    String skillsResponse = await getObject('skills');

    setState(() {
      skillsData = Skills.fromJson(skillsResponse).skills;
    });
  }
